...
function Option() {
  ...
  return (
    <>
      ...
      {/* SMALL SCREENS */}
      <div className=" h-full w-full max-w-full mt-[13rem] flex justify-center items-center phone:block md:hidden ">
        <div className="flex justify-center items-center">
          <div className=" max-w-[65%]   ">
            ...
            <div
              ...
              className={`mt-[20px] ${individual === true ? "border border-[#0098db] text-[#0098db]" : "border-[#b5b5b5] text-[#b5b5b5] "} w-full h-[70px]  rounded-[5px]  pl-[15px] cursor-pointer mt-[10px] text-[14px] border-solid border-[1px] `}
            >
              <div className="flex justify-between items-center w-[72%]  h-full">
                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M15 18.75C17.5888 18.75 19.6875 16.6513 19.6875 14.0625C19.6875 11.4737 17.5888 9.375 15 9.375C12.4112 9.375 10.3125 11.4737 10.3125 14.0625C10.3125 16.6513 12.4112 18.75 15 18.75Z"
                    stroke="currentColor"
            ...
            <div
              ...
              className={`mt-[20px] ${business === true ? "border border-[#0098db] text-[#0098db]" : "border-[#b5b5b5] text-[#b5b5b5] "} w-full h-[70px] pr-[10px] rounded-[5px]   pl-[15px] cursor-pointer text-[14px]  border-solid border-[1px] `}
            >
