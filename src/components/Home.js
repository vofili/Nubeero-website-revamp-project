...
function Home() {
  return (
    <>
      <div className=" flex  w-full h-auto md:pr-[40px] phone:pr-[0px]  justify-between mt-[8rem] lg:ml-[4rem] md:ml-[2rem]  phone:pl-[2rem]  ">
        <div className="lg:mt-[5rem] w-2/4 ">
          <h1 className=" font-semibold  phone:text-[30px]  md:text-[44px] text-[#00325c] ">Intermediation, Tech Solutions & Consulting</h1>
